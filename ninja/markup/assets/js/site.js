$(function() {"use strict";
	...
	//sticky header start
	var stickyWidth = $("body #sticky-add").width();
	...
	$(window).scroll(function() {
		...
		if ($(window).width() > 1024) {
			if($("body").find(".listing-content .slick-track").length > 0){
			var setPosition = parseInt($(".listing-content .slick-track").height() - $("body #sticky-add").height() - 30);

			if ((scrl + $("body .header").outerHeight(true)) > $("body").find(".listing-content .slick-track").offset().top && scrl + $("#sticky-add").height() + $("body .header").outerHeight(true) < $("body").find(".listing-content .slick-slide:last").offset().top + $("body").find(".listing-content .slick-slide:last").height()) {

				pos = (scrl - $("body").find(".listing-content .slick-track").eq(0).offset().top >= 0) ? scrl - $("body").find(".listing-content .slick-track").eq(0).offset().top : 0;
				$("#sticky-add").css({
					"position" : "fixed",
					"top" : $("body .header").outerHeight(true),
					"width" : stickyWidth
				});
			} else if (scrl < $("body").find(".listing-content .slick-track").eq(0).offset().top) {
	...
	// $(".form-input .number-only").keyup(function(){
	// alert()
	// })
